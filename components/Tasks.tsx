...
const Tasks = ({ tasks }: any) => {
  ...
  return (
    <>
      <div className="task_Container pb-20 grid pr-3 lg:grid-cols-3 gap-4 mt-3  grid-cols-1 max-h-[70vh] overflow-y-auto">
        {tasks?.map((item: any) => <Task key={item.id} item={item} />)}
