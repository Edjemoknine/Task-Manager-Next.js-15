...
const TaskForm = ({
  ...
  return (
    <div className="w-96 p-6 z-50 dark:bg-gray-800 text-black flex flex-col justify-between border border-slate-700 md:relative top-0 duration-300 ease-in-out  bg-slate-200 rounded-2xl ">
      <h1>{type} Task</h1>
